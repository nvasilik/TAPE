...
from tape.utils.geometry import rot6d_to_rotmat
...
class SMPLFlow(nn.Module):
    ...
    def forward(self, feats: torch.Tensor, num_samples: Optional[int] = None, z: Optional[torch.Tensor] = None) -> Tuple:
        ...
        Returns:
            pred_smpl_params (Dict): Dilist(self.backbone.parameters())ctionary containing the predicted set of SMPL parameters.
