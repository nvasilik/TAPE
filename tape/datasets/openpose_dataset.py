...
from tape.datasets.utils import split_into_chunks
...
class OpenPoseDataset(ImageDataset):
    ...
    def preprocess(self):
        ...
        tmp_l=[]
        for idx in range(0,620-15,1):
            tmp_l.append((idx,idx+15))
        #import ipdb
        #ipdb.set_trace()
        #self.vid_indices=np.array([(1,16)])
        self.vid_indices=np.array(tmp_l)
